...
def FROSH(T1, P1, u1, driven_mixture, *, mechanism, max_iterations=1000, convergence_criteria=1e-6):
    """
    ...
    Args:
        ...
        driven_mixture: string of comma-separated species: mole fraction pairs
        mechanism: file name of mechanism to be used by Cantera for thermodynamic properties
    ...
    def T5_P5_ideal(P1, T2, P2, gamma2):
    ...
    thermo.TPX = T1, P1, driven_mixture
